...
const reviewImages = [
  ...
  'https://images.pexels.com/photos/458803/pexels-photo-458803.jpeg?auto=compress&cs=tinysrgb&w=600',
  'https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=600',
  'https://images.pexels.com/photos/374694/pexels-photo-374694.jpeg?auto=compress&cs=tinysrgb&w=600'
];
              ...
              <div key={index} className='box rounded-lg shadow-shadow1 bg-white'>
                ...
                <div className='text p-3'>
                  ...
                  <div className='user flex items-center'>
                    <img className='rounded-full w-7 h-7' src={reviewImages[index]} alt='' />
